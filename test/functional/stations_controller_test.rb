...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { SKIP_RAILS_ADMIN_INITIALIZER=false: @station.SKIP_RAILS_ADMIN_INITIALIZER=false, contact_details: @station.contact_details, name: @station.name }
    end
  ...
  test "should update station" do
    put :update, id: @station, station: { SKIP_RAILS_ADMIN_INITIALIZER=false: @station.SKIP_RAILS_ADMIN_INITIALIZER=false, contact_details: @station.contact_details, name: @station.name }
    assert_redirected_to station_path(assigns(:station))
  end
